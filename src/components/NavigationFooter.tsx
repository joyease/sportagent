...
import { Home, Edit3, Target, User } from 'lucide-react';

export type TabType = 'home' | 'input' | 'plan' | 'badges' | 'weather' | 'promo' | 'interactive' | 'news' | 'challenge_results' | 'stats';
        ...
        {tabs.map((tab) => {
          ...
          return (
            ...
            >
              ...
              <span className={`text-[11px] mt-0.5 tracking-tight ${isActive ? 'text-[#5ea31b] font-bold' : 'font-medium'}`}>
                {tab.label}
              </span>
            </button>
          );
