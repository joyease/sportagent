...
export const HomeGrid: React.FC<HomeGridProps> = ({
  ...
  const modules = [
    ...
    },
    {
      ...
      title: '運動建議',
      icon: Sparkles,
      bgClass: 'bg-gradient-to-br from-[#122814] via-[#091a0c] to-[#030d06] border border-lime-800/60 hover:border-lime-400/40 hover:from-[#1b3b1e] hover:to-[#07160a] shadow-md shadow-black/40',
      badge: '半年比較',
      badgeColor: 'bg-lime-950/80 text-lime-300 border border-lime-800/80',
      iconBg: 'bg-white/[0.08] border border-white/10 text-lime-300',
    },
    {
      id: 'plan' as TabType,
      title: '挑戰計畫',
